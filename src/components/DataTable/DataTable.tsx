...
export const DataTable: React.FC<DataTableProps> = ({ data, totals }) => {
    if (data.length === 0) {
        return (
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {
                            data.map((item) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <span className="inline-flex items-center px-2.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                            {item.materialType}
                                        </span>
                                    </td>
